	...
	def _process():
		for item in data:
			try:
				...
				('[B]Send to MDBList[/B]', 'RunPlugin(%s)' % build_url({'mode': 'mdblist.mdblist_send_personal_list',
					'list_name': list_name, 'author': author})),
				('[B]Unlink from MDBList[/B]', 'RunPlugin(%s)' % build_url({'mode': 'mdblist.mdblist_unlink_personal_list',
					'list_name': list_name, 'author': author})),
