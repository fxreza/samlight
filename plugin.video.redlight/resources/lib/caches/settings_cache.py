...
_CREDENTIAL_STRING_SETTINGS = frozenset(('tmdb_api', 'trakt.client', 'trakt.secret', 'tmdb.lists_read_token', 'fanarttv_api', 'omdb_api', 'cloud_backup.token'))
...
{'setting_id': 'punchplay.enabled', 'setting_type': 'boolean', 'setting_default': 'false'},
{'setting_id': 'wetrakr.enabled', 'setting_type': 'boolean', 'setting_default': 'false'},
...
{'setting_id': 'tmdb.list_poll_minutes', 'setting_type': 'action', 'setting_default': '5', 'min_value': '1', 'max_value': '120'},
{'setting_id': 'tmdb.list_sync_on_change', 'setting_type': 'boolean', 'setting_default': 'true'},
