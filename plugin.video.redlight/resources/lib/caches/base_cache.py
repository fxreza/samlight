...
(name text, contents text, total integer, created text, sort_order integer, description text, seen text, poster text, fanart text, author text, updated text, mdblist_id text, tmdb_id text, unique (name, author))',),
'tmdb_lists_db': (
