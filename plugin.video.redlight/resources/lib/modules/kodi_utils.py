...
def context_menu_items():
	...
	{'name': 'TMDb Lists Manager', 'value': 'tmdb_manager'}, {'name': 'TMDb Watchlist', 'value': 'tmdb_watchlist'}, {'name': 'TMDb Favorites', 'value': 'tmdb_favorites'}, {'name': 'Send Lists to TMDb', 'value': 'tmdb_send_lists'},
